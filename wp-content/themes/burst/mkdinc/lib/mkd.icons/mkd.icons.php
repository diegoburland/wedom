...
include get_template_directory()."/mkdinc/lib/mkd.icons/mkd.iconcollection.interface.php";
include get_template_directory()."/mkdinc/lib/mkd.icons/mkd.fontawesome.php";
include get_template_directory()."/mkdinc/lib/mkd.icons/mkd.fontelegant.php";
include get_template_directory()."/mkdinc/lib/mkd.icons/mkd.ionicons.php";
include get_template_directory()."/mkdinc/lib/mkd.icons/mkd.lineaicons.php";
include get_template_directory()."/mkdinc/lib/mkd.icons/mkd.simplelineicons.php";
include get_template_directory()."/mkdinc/lib/mkd.icons/mkd.dripicons.php";

/*
  Class: BurstMikadoIconCollections
...
class BurstMikadoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new BurstMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new BurstMikadoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new BurstMikadoIconsIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new BurstMikadoIconsLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new BurstMikadoSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new BurstMikadoDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getIconCollectionIcons(iBurstMikadoIconCollection $collection) {
...
if( ! function_exists('burst_mikado_init_icon_collections') ){
    function burst_mikado_init_icon_collections(){
        global $burst_mikado_IconCollections;
        
        $burst_mikado_IconCollections = BurstMikadoIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'burst_mikado_init_icon_collections', 0);
}