...
/**
 * Class BurstMikadoDripicons
 */
class BurstMikadoDripicons implements iBurstMikadoIconCollection {
    /**
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = BURST_MIKADO_ROOT . "/css/dripicons/dripicons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="mkd_icon_dripicons dripicon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
