...
if( ! function_exists('burst_mikado_init_google_fonts_array') ){
    function burst_mikado_init_google_fonts_array(){
        global $burst_mikado_fonts_array;
        $burst_mikado_fonts_array =
             array(
                 0   =>
                     array(
    ...
    add_action('after_setup_theme', 'burst_mikado_init_google_fonts_array');
}