...
if(!function_exists('burst_mikado_title_classes')) {
	/**
	 * Function that adds classes to title div.
	 * All other functions are tied to it with add_filter function
	 * @param array $classes array of classes
	 */
	function burst_mikado_title_classes($classes = array()) {
		$classes = array();
		$classes = apply_filters('burst_mikado_title_classes', $classes);
...
if(!function_exists('burst_mikado_title_fontsize')) {
	/**
	 ...
	 */
	function burst_mikado_title_fontsize($classes) {
		...
		if(get_post_meta($id, "mkd_page_title_font_size", true) != ""){
		    ...
		    if(isset($burst_mikado_options['predefined_title_sizes'])) {
		        $page_title_fontsize_class = "title_size_" . $burst_mikado_options['predefined_title_sizes'];
		    }
		}
	...
	add_filter('burst_mikado_title_classes', 'burst_mikado_title_fontsize');
}

if(!function_exists('burst_mikado_title_position_class')) {
	/**
	 * Function that adds class on title based on title position option
	 * Could be left, centered or right
	 * @param $classes original array of classes
	 * @return array changed array of classes
	 */
	function burst_mikado_title_position_class($classes) {
		global $burst_mikado_options;
		global $wp_query;
		...
		if(get_post_meta($id, "mkd_page_title_position", true) != "") {
			...
			$title_position = $burst_mikado_options['page_title_position'];
		}
	...
	add_filter('burst_mikado_title_classes', 'burst_mikado_title_position_class');
}

if(!function_exists('burst_mikado_title_in_grid_class')) {
    /**
     ...
     * @return array changed array of classes
     */
    function burst_mikado_title_in_grid_class($classes) {
        global $burst_mikado_options;
        global $wp_query;
        ...
        if((get_post_meta($id, "mkd_title_content_in_grid", true) == "no")
            || ((get_post_meta($id, "mkd_title_content_in_grid", true) != "yes") && isset($burst_mikado_options['title_content_in_grid']) && $burst_mikado_options['title_content_in_grid'] == 'no')) {
    ...
    add_filter('burst_mikado_title_classes', 'burst_mikado_title_in_grid_class');
}

if(!function_exists('burst_mikado_title_content_shadow')) {
    /**
     ...
     * @return array changed array of classes
     */
    function burst_mikado_title_content_shadow($classes) {
        global $burst_mikado_options;
        global $wp_query;
        ...
        if((get_post_meta($id, "burst_mikado_title_content_shadow", true) == "yes")
            || ((get_post_meta($id, "burst_mikado_title_content_shadow", true) != "no") && isset($burst_mikado_options['title_content_shadows']) && $burst_mikado_options['title_content_shadows'] == 'yes')) {
    ...
    add_filter('burst_mikado_title_classes', 'burst_mikado_title_content_shadow');
}

if(!function_exists('burst_mikado_title_with_paspartu')) {
    /**
     ...
     * @return array changed array of classes
     */
    function burst_mikado_title_with_paspartu($classes) {
        global $burst_mikado_options;

        if((isset($burst_mikado_options['paspartu_below_tittle']) && $burst_mikado_options['paspartu_below_tittle'] == 'yes')) {
    ...
    add_filter('burst_mikado_title_classes', 'burst_mikado_title_with_paspartu');
}

if(!function_exists('burst_mikado_title_background_image_classes')) {
	function burst_mikado_title_background_image_classes($classes) {
		global $burst_mikado_options;
		global $wp_query;
		...
		if(get_post_meta($id, "mkd_responsive-title-image", true) != "") {
			...
			$is_img_responsive = $burst_mikado_options['responsive_title_image'];
		}
		...
		if(get_post_meta($id, "mkd_title-image", true) != ""){
			...
			$title_img = $burst_mikado_options['title_image'];
		}
		...
		if(get_post_meta($id, "mkd_fixed-title-image", true) != ""){
			...
			$is_image_fixed = $burst_mikado_options['fixed_title_image'];
		}
	...
	add_filter('burst_mikado_title_classes', 'burst_mikado_title_background_image_classes');
}

if(!function_exists('burst_mikado_title_text_is_hidden_class')) {
	function burst_mikado_title_text_is_hidden_class($classes) {
		global $burst_mikado_options;
		global $wp_query;
	...
	add_filter('burst_mikado_title_classes', 'burst_mikado_title_text_is_hidden_class');
}

if(!function_exists('burst_mikado_title_oblique_class')) {
	function burst_mikado_title_oblique_class($classes) {
		global $burst_mikado_options;
		global $wp_query;
	...
	add_filter('burst_mikado_title_classes', 'burst_mikado_title_oblique_class');
}

if(!function_exists('burst_mikado_title_breadcrumb_type_class')) {
    function burst_mikado_title_breadcrumb_type_class($classes) {
        global $burst_mikado_options;
        global $wp_query;
    ...
    add_filter('burst_mikado_title_classes', 'burst_mikado_title_breadcrumb_type_class');
}

if(!function_exists('burst_mikado_title_background_color_class')) {
	function burst_mikado_title_background_color_class($classes) {
		global $burst_mikado_options;
		global $wp_query;
		...
		if(get_post_meta($id, "mkd_page-title-background-color", true) != ""){
			...
			$title_bg_color = $burst_mikado_options['title_background_color'];
		}
	...
	add_filter('burst_mikado_title_classes', 'burst_mikado_title_background_color_class');
}