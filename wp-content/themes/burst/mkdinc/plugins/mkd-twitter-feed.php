 ...
 */
add_action( 'tgmpa_register', 'burst_mikado_register_mkd_twitter_feed' );
/**
 ...
 */
function burst_mikado_register_mkd_twitter_feed() {
    /**
    ...
    $plugins = array(
        ...
        array(
            'name'			=> 'Mikado Twitter Feed', // The plugin name
            'slug'			=> 'mikado-twitter-feed', // The plugin slug (typically the folder name)
            'source'			=> get_template_directory() . '/plugins/mikado-twitter-feed.zip', // The plugin source
