 ...
 */
if(!function_exists('burst_mikado_register_theme_included_plugins')) {

	/**
	 * Registers theme required and optional plugins. Hooks to tgmpa_register hook
	 */

	function burst_mikado_register_theme_included_plugins()	{
		...
		$plugins = array(
            ...
            array(
                'name'               => esc_html__('Mikado Twitter Feed', 'burst'),
            ...
            array(
                'name'               => esc_html__('Burst Instagram Feed', 'burst'),
                'slug'               => 'burst-instagram-feed',
                'source'             => get_template_directory().'/plugins/burst-instagram-feed.zip',
                'required'           => true,
                'version'            => '1.0',
                'force_activation'   => false,
                'force_deactivation' => false,
	...
	add_action( 'tgmpa_register', 'burst_mikado_register_theme_included_plugins' );
}
...
if (class_exists('WPBakeryVisualComposerAbstract')) {
	function burst_mikado_require_vc_extend(){
		require_once get_template_directory() . '/extendvc/extend-vc.php';
	}
	add_action('after_setup_theme', 'burst_mikado_require_vc_extend',2);
}