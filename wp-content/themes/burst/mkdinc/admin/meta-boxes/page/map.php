...
$mkd_enable_content_top_margin = new BurstMikadoMetaField(
	"yesnosimple",
	"mkd_enable_content_top_margin",
	"no",
	esc_html__( "Always put content below header", 'burst' ),
	esc_html__( "Enabling this option always will put content below header ", 'burst' )
);
$row1->addChild(
	"mkd_enable_content_top_margin",
	$mkd_enable_content_top_margin
...
$mkd_page_vertical_area_transparency = new BurstMikadoMetaField(
	...
	esc_html__( "Enabling this option will make Side Menu background transparent ", 'burst' ),
	array(
		"no" => esc_html__( "No", 'burst' ),
		"yes" => esc_html__( "Yes", 'burst' )
	)
...
$mkd_page_vertical_area_background = new BurstMikadoMetaField(
	...
	esc_html__( "Choose a color for Side Menu background", 'burst' )
);
$mkdLeftMenuArea->addChild(
	"mkd_page_vertical_area_background",
	$mkd_page_vertical_area_background
...
$mkd_show_page_title = new BurstMikadoMetaField(
	...
	array(
		"dependence" => true,
		"hide"       => array(
			"no" => "#mkdf_mkd_page_title_area_container, #mkdf-meta-box-page_title_animations"
		),
		"show"       => array(
			""    => "#mkdf_mkd_page_title_area_container, #mkdf-meta-box-page_title_animations",
			"yes" => "#mkdf_mkd_page_title_area_container, #mkdf-meta-box-page_title_animations"
		)
	)
);
$mkdTitle->addChild(
...
$mkd_page_title_font_size = new BurstMikadoMetaField(
	"selectblanksimple",
	"mkd_page_title_font_size",
	"",
...
$mkd_show_page_title_image = new BurstMikadoMetaField(
	...
	array(
		...
		"dependence_show_on_yes" => "#mkdf_mkd_title-height"
	)
);
$mkd_page_title_area_container->addChild(
	"mkd_show-page-title-image",
...
$mkd_enable_breadcrumbs = new BurstMikadoMetaField(
	...
	array(
		"dependence" => true,
		"hide"       => array(
			""   => "#mkdf_animation_page_page_title_breadcrumbs_container,#mkdf_mkd_page_breadcrumbs_style_container",
			"no" => "#mkdf_animation_page_page_title_breadcrumbs_container,#mkdf_mkd_page_breadcrumbs_style_container"
		),
		"show"       => array(
			"yes" => "#mkdf_animation_page_page_title_breadcrumbs_container,#mkdf_mkd_page_breadcrumbs_style_container"
		)
	)
);
$mkd_page_title_area_container->addChild(
...
$mkd_page_breadcrumbs_style_container = new BurstMikadoContainer(
	"mkd_page_breadcrumbs_style_container",
	"mkd_enable_breadcrumbs",
	"no"
);
$mkd_page_title_area_container->addChild(
...
$group32 = new BurstMikadoGroup(
	esc_html__( "Breadcrumbs Style", 'burst' ),
	esc_html__( 'Define Breadcrumbs style', 'burst' )
);
$mkd_page_breadcrumbs_style_container->addChild(
	"group32",
	$group32
);
...
$mkd_page_active_breadcrumbs_color = new BurstMikadoMetaField(
	"colorsimple",
	"mkd_page_active_breadcrumbs_color",
	"",
	esc_html__( "Breadcrumbs Active/Hover Color", 'burst' )
);
$row1->addChild(
	"mkd_page_active_breadcrumbs_color",
	$mkd_page_active_breadcrumbs_color
...
$mkdBlog = new BurstMikadoMetaBox(
	"page",
...
$mkd_choose_blog_category = new BurstMikadoMetaField(
	"selectblank",
	"mkd_choose-blog-category",
	"",
	esc_html__( "Blog Category", 'burst' ),
	esc_html__( "Choose category of posts to display (leave empty to display all categories)", 'burst' ),
	$mkd_blog_categories
);
$mkdBlog->addChild(
	"mkd_choose-blog-category",
	$mkd_choose_blog_category
);

$mkd_show_posts_per_page = new BurstMikadoMetaField(
	"text",
	"mkd_show-posts-per-page",
	"",
	esc_html__( "Number of Posts", 'burst' ),
	esc_html__( "Enter the number of posts to display", 'burst' ),
	array(),
	array( "col_width" => 3 )
);
$mkdBlog->addChild(
	"mkd_show-posts-per-page",
	$mkd_show_posts_per_page
);

$mkd_enable_page_comments = new BurstMikadoMetaField(
	"yesno",
	"mkd_enable-page-comments",
	"no",
	esc_html__( "Show Comments", 'burst' ),
	esc_html__( "Enabling this option will show comments on your page ", 'burst' )
);
$mkdBlog->addChild(
	"mkd_enable-page-comments",
	$mkd_enable_page_comments
);
...
$mkdFullScreenTemplate = new BurstMikadoMetaBox(
	"page",
	esc_html__( "Full Screen Template", 'burst' )
);
burst_mikado_return_framework_variable()->mkdMetaBoxes->addMetaBox(
	"page_full_screen_template",
	$mkdFullScreenTemplate
);

$mkd_full_screen_sections_on_small_screens = new BurstMikadoMetaField(
	"selectblank",
	"mkd_full_screen_sections_on_small_screens",
	"",
...
$mkdFullScreenTemplate->addChild(
	"mkd_full_screen_sections_on_small_screens",
	$mkd_full_screen_sections_on_small_screens
);
