...
class BurstMikadoSkin extends BurstMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to burst_mikado_admin_scripts_init and burst_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('burst_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('burst_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('burst_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('burst_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        
        add_action('burst_mikado_enqueue_meta_box_styles', array($this, 'enqueueMetaStyles'));
        add_action('burst_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            burst_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        $this->styles['fontawesome-icons-admin'] = 'assets/css/font-awesome/css/font-awesome.min.css';

        foreach ($this->styles as $styleHandle => $stylePath) {
            burst_mikado_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        ...
        $tab    		= burst_mikado_get_admin_tab();
        $active_page 	= $burst_mikado_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param BurstMikadoAdminPage $page current page to load
...
*@param BurstMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkdf-options-page mkdf-page">
            <?php $this->getHeader(burst_mikado_get_theme_info_item('Name'), burst_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkdf-page-content-wrapper">
                <div class="mkdf-page-content">
                    <div class="mkdf-page-navigation mkdf-tabs-wrapper vertical left clearfix">
