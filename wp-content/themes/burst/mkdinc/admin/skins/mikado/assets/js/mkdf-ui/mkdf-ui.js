(function($){
    ...
    $(window).load(function(){
        mkdfShowHidePostFormatsWithGutenberg();
    })
    ...
    function mkdChangedInput () {
        ...
        $('.mkdf-tabs-content form.mkd_ajax_form:not(.mkdf-import-page-holder) .field.switch label:not(.selected)').on('click',  function() {
            $('.mkdf-input-change').addClass('yes');
        });
        ...
        $('.mkdf-tabs-content form.mkd_ajax_form:not(.mkdf-import-page-holder) #anchornav input').on('click', function() {
            if ($('.mkdf-input-change.yes').length) {
            ...
            frame: function() {
                ...
                this._frame.on('update', function() {
                    ...
                    jQuery.ajax({
                        type: "post",
                        url: ajaxurl,
                        data: "action=burst_mikado_gallery_upload_get_images&ids=" + ids,
    ...
    function mkdfInitPortfolioItemsBox() {
        ...
        $('a.mkdf-add-item').on('click', function (event) {
            event.preventDefault();
...
//            }
	...
	function mkdfShowHidePostFormatsWithGutenberg(){
        ...
        if(gutenbergEditor.length) {
            ...
            gPostFormatField.find('select option').each(function () {
                ...
                $('#mkdf-meta-box-post-format-' + $(this).val()).hide();
            });

            if (gPostFormatField.find('select option:selected')) {
                $('#mkdf-meta-box-post-format-' + gPostFormatField.find('select option:selected').val()).fadeIn();
            }
