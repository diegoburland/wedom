...
if( ! class_exists('BurstMikadoSidebar') ){
	
	class BurstMikadoSidebar{
		...
		function __construct(){
			...
			$this->title = esc_html__('Custom Widget Area','burst');
		...
		function load_assets(){
			...
			wp_enqueue_script('burst-mikado-sidebar', BURST_MIKADO_ROOT . '/mkdinc/admin/assets/js/mkdf-sidebar.js');
			wp_enqueue_style( 'burst-mikado-sidebar', BURST_MIKADO_ROOT . '/mkdinc/admin/assets/css/mkdf-sidebar.css');
		}
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".esc_html__('Enter Name of the new Widget Area', 'burst')."' name='mkd-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".esc_html__('Add Widget Area', 'burst')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
