...
function singleTitleAnimation() {
    ...
    if($j('.single-post .blog_holder article.format-quote ').length){
     ...
     if($j('.single-post .blog_holder article.format-link').length){
        $j('.single-post .blog_holder article.format-link').each(function(){

            $j(this).find('.post_title.link h3').addClass('load-animation');
