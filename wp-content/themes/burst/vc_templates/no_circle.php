...
if($background_color != "") {
    if($background_transparency !="") {
        $bg_color = burst_mikado_hex2rgb($background_color);
...
if($gap_color != "") {
    $circle_wrapper_style .= " background-color: ".$gap_color.";";
}
if($border_width != "") {
...
$html .= '<div class="mkd_circle_inner'. $border_class.' " style="'.$circle_wrapper_style.'"><div class="mkd_circle_inner2 '.$image_with_text_class.'" style="'.$circle_style.' '.$image_with_text_style.'">';
