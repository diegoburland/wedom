...
$output .= '<span data-line-width="'.$line_width.'"  class="'.$css_class . $animation_class.' '.$text_position.'">';
    ...
    if ($text_position == 'center' || $text_position == 'right') {
        $output .= '<span class="mkd_line_before '.$separator_line_classes.'"  style="'.implode(';', $separator_lines_styles).';'.$line_right_margin.'">';
    }
    if($line_dots == "yes") {
        $output .= '<span class="mkd_separator_line_inner" style="' . implode(';', $separator_line_dots_style) . ';' . $separator_line_left_dot_position . '"></span>';
    }
    if ($text_position == 'center' || $text_position == 'right') {
        $output .= '</span>'; // end mkd_line_before
    }
    ...
    if ($text_position == 'center' || $text_position == 'left') {
        $output .= '<span class="mkd_line_after '.$separator_line_classes.'" style="'.implode(';', $separator_lines_styles).';'.$line_left_margin.'">';
    }
    if($line_dots == "yes") {
    ...
    if ($text_position == 'center' || $text_position == 'left') {
        $output .= '</span>'; // end mkd_line_after
    }
