...
if($border_arround == "yes"){
	$border_arround_style .= "border: 1px solid #e9e9e9;";
}
...
if($price_bckg_image !== "") {
	...
	$price_background_style .= $border_arround_style;
}
...
if($content_background_image != ""){
	...
	$content_border_around .= $border_arround_style;
}
...
if(is_array($title_style) && count($title_style)) {
    $title_style = 'style="'.implode(';', $title_style).'"';
} else {
    $title_style = '';
}
...
if($title_background_image != '') {
	...
	$title_holder_style .= $border_arround_style;
}
...
if($type=="price_on_top" ){
    $html .= "<li class='prices' " . burst_mikado_get_inline_style(array($price_background_style,"border-color: ".$border_arround_color.";")) . ">";
    $html .= "<div class='price_in_table'>";
    $html .= "<sup class='value'>".$currency."</sup>";
    $html .= "<span class='price' ".burst_mikado_get_inline_style($price_style_array).">".$price."</span>";
    $html .= "<span class='mark'>/ ".$price_period."</span>";

    $html .= "</div>"; // close div.price_in_table
    $html .= "</li>"; //close li.prices
    $html .= "<li class='cell table_title ".$title_clasess."' ".burst_mikado_get_inline_style(array($title_holder_style,"border-color: ".$border_arround_color.";"))."><span class='title_content' ".$title_style.">".$title."</span>";
...
if($type=="title_on_top"){	
    $html .= "<li class='cell table_title ".$title_clasess."' ".burst_mikado_get_inline_style(array($title_holder_style,"border-color: ".$border_arround_color.";")).">";
    $html .= "<span class='title_content' ".$title_top_type_title_style.">".$title."</span>";
    $html .= "</li>";    

    $html .= "<li class='prices $pricing_content_clasess' ".burst_mikado_get_inline_style(array($price_background_style,"border-color: ".$border_arround_color.";")).">";
    $html .= "<div class='price_in_table'>";
    $html .= "<sup class='value'>".$currency."</sup>";
    $html .= "<span class='price' ".burst_mikado_get_inline_style($price_style_array).">".$price."</span>";
    $html .= "<span class='mark'>/ ".$price_period."</span>";
...
$html .= "<li class='pricing_table_content $pricing_content_clasess ' style='".$content_text_style." ".$pricing_table_background." ".$content_border_around."' $data_attr>";
...
if($show_button == "yes"){
	if($pricing_button_type == "standard_button"){
		if(isset($button_text) && $button_text !== '') {
			$html .="<li class='price_button $button_class' ".burst_mikado_get_inline_style($button_holder_style)." >";
			if($type=="title_on_top"){
				$html .= "<div class='title_on_top_button_wrapper $disable_button_border_top_class'>";
				$html .= "<a ".burst_mikado_get_inline_style($button_style)." href='$link' target='$target'>".$button_text."";
				if($button_arrow == "yes"){
		...
		$html .="<a class='button_on_bottom' ".burst_mikado_get_inline_style($button_on_bottom_styles)." href='$link' target='$target'></a>";
		$html .="</li>";//close li.price_button
	}
}
