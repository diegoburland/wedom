...
$html .= "<div class='mkd_elements_item_content " . $random_custom_class . "' style='". $mkd_elements_item_inner_style ."' data-item-class='" . $random_custom_class . "'";
if($item_padding_1300_1600 !== "" || $item_padding_1024_1300 !== "" || $item_padding_768_1024 !== "" || $item_padding_600_768 !== "" || $item_padding_480_600 !== "" || $item_padding_480 !== ""){
    if($item_padding_1300_1600){
        $html .= "data-1300-1600='" . $item_padding_1300_1600 . "'";
    }
    if($item_padding_1024_1300){
        $html .= "data-1024-1300='" . $item_padding_1024_1300 . "'";
    }
