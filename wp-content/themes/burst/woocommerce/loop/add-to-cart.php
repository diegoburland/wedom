...
global $product,$burst_mikado_options;

$animate_button_class='';
if(isset($burst_mikado_options['add_to_cart_button_hover_animation']) && ($burst_mikado_options['add_to_cart_button_hover_animation'] !== '')){
	$animate_button_class = $burst_mikado_options['button_hover_animation'];
}
