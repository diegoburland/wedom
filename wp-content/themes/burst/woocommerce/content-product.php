...
$show_hover_image = 'no';
if(isset($burst_mikado_options['woo_products_enable_item_hover_image'])){
	$show_hover_image = $burst_mikado_options['woo_products_enable_item_hover_image'];
}

$woo_products_enable_lighbox_icon_yes_no = "yes";

if(isset($burst_mikado_options['woo_products_enable_lighbox_icon'])){
	$woo_products_enable_lighbox_icon_yes_no =  $burst_mikado_options['woo_products_enable_lighbox_icon'];
}

$hide_separator = "no";
if(isset($burst_mikado_options['woo_products_title_separator_hide_title_separator'])){
	$hide_separator = $burst_mikado_options['woo_products_title_separator_hide_title_separator'];
}
?>
