...
if ( $max_value && $min_value === $max_value ) {
	...
	$labelledby = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'burst' ), strip_tags( $args['product_name'] ) ) : '';
	?>
	<div class="quantity buttons_added">
		<input 
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'burst' ) ?>"
			size="4" 
