...
if ( ! empty( $tabs ) ) : ?>
    ...
    <?php if(isset($burst_mikado_options['woo_products_info_style']) && ($burst_mikado_options['woo_products_info_style'])=="vertical_tabs"){?>
	...
	<?php }  else {?>
		<div class="mkd_accordion_holder toggle boxed woocommerce-accordion <?php if(isset($burst_mikado_options['accordion_toggle_boxed_background_pattern']) && $burst_mikado_options['accordion_toggle_boxed_background_pattern']!='no'){ echo "has_pattern";} ?>">
			<?php foreach ( $tabs as $key => $tab ) : ?>
