...
if (isset($burst_mikado_options['blog_standard_type_read_more_button_icon']) && $burst_mikado_options['blog_standard_type_read_more_button_icon'] == 'yes'){
			...
			<div class="post_content_holder">
				 ...
				 <div class="post_date_title clearfix">
					<?php if ($burst_mikado_blog_show_date == "yes") { ?>
                 		<?php burst_mikado_post_info(array('date' => $burst_mikado_blog_show_date)); ?>
                 	<?php } ?>
                 	<h2>
                 ...
                 <div class="post_text">
                    <div class="post_text_inner">         
						<?php
                        if( burst_mikado_wp_link_pages_exist() ){
                            burst_mikado_wp_link_pages();
                        } else {
                            burst_mikado_excerpt();
                            burst_mikado_read_more_button('blog_standard_type_read_more_button', $burst_mikado_blog_read_more_button_classes);
                        } ?>
						<?php if($burst_mikado_blog_show_author == "yes" || $burst_mikado_blog_show_date == "yes" || $burst_mikado_blog_show_social_share == "yes" || $burst_mikado_blog_show_categories == "yes" || $burst_mikado_blog_show_comments == "yes" || $burst_mikado_blog_show_like == "yes") { ?>	
							<div class="post_info">
								...
								<?php } ?>
								<?php burst_mikado_post_info(array('author' => $burst_mikado_blog_show_author, 'share' => $burst_mikado_blog_show_social_share, 'category' => $burst_mikado_blog_show_categories, 'comments' => $burst_mikado_blog_show_comments, 'like' => $burst_mikado_blog_show_like)); ?>
							</div>
						<?php } ?>
